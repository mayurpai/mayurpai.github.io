...
<html>
	...
	<body>
		...
		<div>
			...
			<p id="fp">I wouldn't describe myself as a Master of anything, nor I dream about success, I WORK for it. <br>
					   Ever since I was a little kid, Computers have fascinated me and has driven my passion and craze for it. <br>
					   I still remember starting up my first ever programming language C , compiling "Hello Mayur" and since <br>
					   then moved onto learning various other languages. Learning new things on a daily basis has always <br> 
					   been my priority. <br> <br>
					   This passion carried me through my education at Sahyadri. I studied languages, algorithms, built up my <br>
					   technicality, leadership skills and much more. There's certainly yet more to learn, yet more problems <br> 
					   to solve, and yet more to build.</p>
            <div class="html_tags">
				&lt;/body&gt; <br>
			</div>
			<div class="html-tag">
